...
% 两人联盟
v_local.S5 = -1.52;   % {1,2}
v_local.S6 = 22.08;    % {1,3}
v_local.S7 = 13.78;     % {1,4}
v_local.S8 = 28.36;    % {2,3}
v_local.S9 = 3.38;    % {2,4}
v_local.S10 = 21.08;   % {3,4}

% 三人联盟
v_local.S11 = 29.57;   % {1,2,3}
v_local.S12 = 6.76;   % {1,2,4}
v_local.S13 = 28.91;   % {1,3,4}
v_local.S14 = 29.31;   % {2,3,4}
